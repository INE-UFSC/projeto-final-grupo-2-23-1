...
class Menu:
    def __init__(self, res):
        ...
        self.__start_button = Button((0, 0, 0), self.__width/2 - 100, self.__height/2 +125, 200, 100, 'Start', self.x)
    ...
    def draw(self):
        ...
        if self.__x == False:
            ...
            return True
#TODO: fazer funcionar a logica de apertar botao pq estou coringando ja com isso
    def x(self, value = True):
        self.__x == value
