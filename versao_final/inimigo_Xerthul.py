...
class Xerthul(Entidade, pg.sprite.Sprite):
    '''Aerethor é o inimigo mais básico, ele voa e atira projéteis no jogador.'''

    def __init__(self):
        Entidade.__init__(self, 45, 2.2, 4, 0.25)
        pg.sprite.Sprite.__init__(self)

        self.__angulo = 0

        Xerthul_img = pg.image.load(os.path.join('sprites', 'Xerthul.png')).convert_alpha()

        self.image = pg.transform.scale(Xerthul_img, (30, 50))
        ...
        self.__tipo_projetil = ProjetilLinear(10, 550, 7, (255, 0, 0), 1)
